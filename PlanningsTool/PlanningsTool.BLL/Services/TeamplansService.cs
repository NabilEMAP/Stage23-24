...
namespace PlanningsTool.BLL.Services
{
    public class TeamplansService : ITeamplansService
    {
        ...
        {
            var teamplanningen = await _uow.TeamplansRepository.GetAllAsync();
            return _mapper.Map<IEnumerable<TeamplanDTO>>(teamplanningen);
        }

        public async Task<TeamplanDTO> GetById(int id)
        {
            var teamplanning = await _uow.TeamplansRepository.GetByIdAsync(id);
        ...
        {
            var toDeleteTeamplanning = await _uow.TeamplansRepository.GetByIdAsync(id);
        ...
        public async Task<TeamplanDTO> Update(int id, UpdateTeamplanDTO entity)
        {
            ...
            var teamplanningToUpdate = await _uow.TeamplansRepository.GetByIdAsync(id);
