...
{
    public partial class updateSeedingMoreTeams : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 13, "Emily", "0", "Johnson", 1, 2 },
                    { 14, "Sophia", "0", "Martinez", 1, 2 },
                    { 15, "Olivia", "0", "Thompson", 1, 2 },
                    { 16, "Ava", "0", "Davis", 1, 2 },
                    { 17, "Mia", "0", "Rodriguez", 1, 2 },
                    { 18, "Isabella", "0", "Garcia", 1, 2 },
                    { 19, "Charlotte", "0", "Hernandez", 2, 2 },
                    { 20, "Amelia", "0", "Wilson", 2, 2 },
                    { 21, "Harper", "0", "Lopez", 3, 2 },
                    { 22, "Evelyn", "1", "Lee", 1, 2 },
                    { 23, "Abigail", "1", "Perez", 1, 2 },
                    { 24, "Ella", "1", "Scott", 2, 2 },
                    { 25, "Emma", "0", "Nguyen", 3, 3 },
                    { 26, "Madison", "0", "Taylor", 2, 3 },
                    { 27, "Elizabeth", "0", "Wright", 1, 3 },
                    { 28, "Grace", "1", "King", 1, 3 },
                    { 29, "Victoria", "0", "Adams", 3, 3 },
                    { 30, "Claire", "0", "Turner", 2, 3 },
                    { 31, "Lily", "0", "Parker", 1, 3 },
                    { 32, "Zoey", "1", "Lewis", 2, 3 },
                    { 33, "Riley", "0", "Hill", 3, 3 },
                    { 34, "Aria", "0", "Ross", 3, 3 },
                    { 35, "Stella", "0", "Reed", 3, 3 },
