    ...
    public static class NurseSeeding
    {
        public static void Seed(this EntityTypeBuilder<Nurse> modelBuilder)
        {
            modelBuilder.HasData(
                ...
                // Team Red
                new Nurse() { Id = 13, FirstName = "Emily", LastName = "Johnson", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 14, FirstName = "Sophia", LastName = "Martinez", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 15, FirstName = "Olivia", LastName = "Thompson", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 16, FirstName = "Ava", LastName = "Davis", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 17, FirstName = "Mia", LastName = "Rodriguez", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 18, FirstName = "Isabella", LastName = "Garcia", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 19, FirstName = "Charlotte", LastName = "Hernandez", RegimeTypeId = 2, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 20, FirstName = "Amelia", LastName = "Wilson", RegimeTypeId = 2, IsFixedNight = true,  TeamId = 2, },
                new Nurse() { Id = 21, FirstName = "Harper", LastName = "Lopez", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 2, },
                ...
                // Team Blue
                new Nurse() { Id = 25, FirstName = "Emma", LastName = "Nguyen", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 26, FirstName = "Madison", LastName = "Taylor", RegimeTypeId = 2, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 27, FirstName = "Elizabeth", LastName = "Wright", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 28, FirstName = "Grace", LastName = "King", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 29, FirstName = "Victoria", LastName = "Adams", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 30, FirstName = "Claire", LastName = "Turner", RegimeTypeId = 2, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 31, FirstName = "Lily", LastName = "Parker", RegimeTypeId = 1, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 32, FirstName = "Zoey", LastName = "Lewis", RegimeTypeId = 2, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 33, FirstName = "Riley", LastName = "Hill", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 34, FirstName = "Aria", LastName = "Ross", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 3, },
                new Nurse() { Id = 35, FirstName = "Stella", LastName = "Reed", RegimeTypeId = 3, IsFixedNight = true,  TeamId = 3, },
