...
{
    public partial class cleanUpdateSeedingTeamWnL : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Team W&L" });

            migrationBuilder.InsertData(
                schema: "dbo",
                table: "Teamplans",
                columns: new[] { "Id", "CreatedOn", "Name", "PlanFor" },
                values: new object[] { 1, new DateTime(2024, 5, 15, 22, 7, 19, 0, DateTimeKind.Unspecified), "2024-05-16-00-07-19 W&L", new DateTime(2022, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
